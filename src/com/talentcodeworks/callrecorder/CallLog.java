    ...
    extends Activity
{
    ...
    private class CallItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) 
        {
            ...
            File f = new File(CallRecorder.DEFAULT_STORAGE_LOCATION + "/" + s.toString());
    ...
    private void playFile(String fName) {
        ...
        playIntent.putExtra(PlayService.EXTRA_FILENAME, CallRecorder.DEFAULT_STORAGE_LOCATION + "/" + fName);
