    ...
    implements MediaRecorder.OnInfoListener, MediaRecorder.OnErrorListener
{
    ...
    */
    ...
    {
        File dir = new File(CallRecorder.DEFAULT_STORAGE_LOCATION);
...
//            }else{
//            	Toast t = Toast.makeText(getApplicationContext(), "File is not found " + path, Toast.LENGTH_LONG);
//            }
           ...
           // recorder.setOnErrorListener(this);
            ...
            try {
                ...
                Log.e("CallRecorder java.io.IOException Line 172", "RecordService::onStart() IOException attempting recorder.prepare()\n");
                Toast t = Toast.makeText(getApplicationContext(), "CallRecorder java.io.IOException Line 173 was unable to start recording: " + path, Toast.LENGTH_LONG);
                t.show();
                if (recorder != null) {
                	recorder.release();
                	recorder = null;
            ...
            Toast t = Toast.makeText(getApplicationContext(), "Completed " + e, Toast.LENGTH_LONG);
            t.show();
    ...
    public void onDestroy()
    {
        ...
        if (null != recorder) {
            ...
            Toast t = Toast.makeText(getApplicationContext(), "CallRecorder java.io.IOException Line 203 CallRecorder finished recording call to " + recording, Toast.LENGTH_LONG);
            t.show();
